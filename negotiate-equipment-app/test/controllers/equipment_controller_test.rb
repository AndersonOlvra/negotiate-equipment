...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference("Equipment.count") do
      post equipment_index_url, params: { equipment: { description: @equipment.description, nam: @equipment.nam, price: @equipment.price, user_id: @equipment.user_id } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { description: @equipment.description, nam: @equipment.nam, price: @equipment.price, user_id: @equipment.user_id } }
